...
from lib.models.artrackv2_seq.refinement_module import build_token_refiner
...
class ARTrackV2Seq(nn.Module):
    ...
    def forward(self, template: torch.Tensor,
        ...
        out, z_0_feat, z_1_feat, x_feat, score_feat,score_n_feat = self.backbone(z_0=template_0, z_1_feat=dz_feat, x=search, identity=self.identity, seqs_input=seq_input,flag=flag,
